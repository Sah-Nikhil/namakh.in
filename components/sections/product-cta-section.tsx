            ...
            <div className="max-w-4xl mx-auto text-center space-y-12">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div className="group p-8 rounded-3xl bg-white dark:bg-neutral-800 border border-black/10 dark:border-white/10 hover:border-blue-500/50 transition-all">
                        ...
                        <Link href="/shop/hydration-blend" className="block w-full py-3 rounded-full bg-black/5 dark:bg-white/10 hover:bg-black dark:hover:bg-white text-black dark:text-white hover:text-white dark:hover:text-black font-bold transition-all">
                            Shop Hydration
                        </Link>
                    </div>
                    ...
                    <div className="group p-8 rounded-3xl bg-white dark:bg-neutral-800 border border-black/10 dark:border-white/10 hover:border-red-500/50 transition-all">
                        ...
                        <Link href="/shop/sports-blend" className="block w-full py-3 rounded-full bg-black/5 dark:bg-white/10 hover:bg-black dark:hover:bg-white text-black dark:text-white hover:text-white dark:hover:text-black font-bold transition-all">
                            Shop Sports
                        </Link>
                    </div>
                </div>
