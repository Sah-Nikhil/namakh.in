...
export default function ScienceSection() {
    return (
        <section className="w-full py-16 px-4 bg-white dark:bg-neutral-900 relative overflow-hidden">
            <div className="max-w-5xl mx-auto text-center space-y-12 relative z-10">
                <motion.div
                    ...
                    className="space-y-6"
                >
                    <h2 className="text-sm font-semibold tracking-[0.3em] text-blue-400 dark:text-blue-300 uppercase">The Science Behind Namakh</h2>
                    <p className="text-3xl md:text-5xl font-bold leading-tight dark:text-white">
